...
{
    public partial class FrmLendToSale : Formbase
    { 
        ...
        private void FrmLendToSale_Load(object sender, EventArgs e)
        {
            this.TResult = "";
                        ...
                        if (dataGridViewT2.SelectedRows.Count > 0)
                        {
                            for (int i = 0; i < dataGridViewT2.Rows.Count; i++)
                            {
                                if (dataGridViewT2["點選", i].Value.ToString() == "V")
                                {
                                    ...
                                    LeNo = dataGridViewT2["借出憑證", i].Value.ToString();
                                    break;
                                }
                            }
        ...
        {
            if (dataGridViewT2.Rows.Count > 0)
                dataGridViewT2.Search("借出憑證", leno.Text, "客戶編號", qitno.Text);
        }
    }
}
