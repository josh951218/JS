...
namespace S_61.S2
{
    public partial class FrmBShopDisBrow : Formbase, JBS.JS.IxOpen
    {
        ...
        private void FrmBShopDisBrow_Load(object sender, EventArgs e)
        {
            this.TResult = "";

            SQL = "";
            if (Common.User_DateTime == 1)
                SQL = "LEFT(bshopdisd.indate,3)+'/'+SUBSTRING(bshopdisd.indate,4,2)+'/'+RIGHT(bshopdisd.indate,2) 發票日期,";
            else
                SQL = "LEFT(bshopdisd.indate1,4)+'/'+SUBSTRING(bshopdisd.indate1,5,2)+'/'+RIGHT(bshopdisd.indate1,2) 發票日期,";

            SQL += @"
                 bshopdisd.inid,bshopdisd.inno,bshopdisd.indate,bshopdisd.indate1,bshopdisd.cono,bshopdisd.fano,bshopdisd.itno,bshopdisd.itname,bshopdisd.itunit
                ,bshopdisd.punit,bshopdisd.bomid,bshopdisd.bomrec,bshopdisd.ittrait,bshopdisd.itpkgqty,bshopdisd.pqty,bshopdisd.qty,bshopdisd.price
                ,bshopdisd.prs,bshopdisd.rate,bshopdisd.xa1par,bshopdisd.taxprice,bshopdisd.mny,bshopdisd.priceb,bshopdisd.taxpriceb,bshopdisd.mnyb
                ,bshopdisd.memo,bshopdisd.recordno,bshopdis.faname1,bshopdis.coname1,inputday,bshopdis.dino
                From bshopdisd
            ...
            try
            {
                ...
                GetData("bshopdisd", "dino", this.TSeekNo.Trim(), "dino ASC", btnInputDay);
            }
            finally
            {
        ...
        private void FrmBShopDisBrow_Shown(object sender, EventArgs e)
        {
            tInNo.Focus();
        }
        ...
        private void Q2_Click(object sender, EventArgs e)
        {
            ...
            {
                Q2.Enabled = false;
                GetData("bshopdisd", "InNo", "InNo ASC", Q2);
            }
            finally
            {
                Q2.Enabled = true;
        ...
        private void Q3_Click(object sender, EventArgs e)
        {
            ...
            {
                Q3.Enabled = false;
                GetData("bshopdisd", "InDate", "InDate DESC", Q3, "DESC");
            }
            finally
            {
                Q3.Enabled = true;
        ...
        private void Q4_Click(object sender, EventArgs e)
        {
            ...
            {
                Q4.Enabled = false;
                GetData("bshopdisd", "FaNo", "FaNo ASC", Q4);
            }
            finally
            {
                Q4.Enabled = true;
        ...
        private void Q5_Click(object sender, EventArgs e)
        {
            ...
            {
                Q5.Enabled = false;
                GetData("bshopdisd", "ItNo", "ItNo ASC", Q5);
            }
            finally
            {
                Q5.Enabled = true;
        ...
        private void Q6_Click(object sender, EventArgs e)
        {
            ...
            {
                Q6.Enabled = false;
                GetData("bshopdisd", "Memo", "Memo ASC", Q6);
            }
            finally
            {
                Q6.Enabled = true;
        ...
        private void Q7_Click(object sender, EventArgs e)
        {
            ...
            {
                Q7.Enabled = false;
                GetData("bshopdisd", "CoNo", "CoNo ASC", Q7);
            }
            finally
            {
                Q7.Enabled = true;
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    GetData("bshopdisd", "InNo", tInNo.Text.Trim(), "InNo ASC", Q2);
                }
                else if (tInDate.TrimTextLenth() > 0)
                {
                    GetData("bshopdisd", "InDate", tInDate.Text.Trim(), "InDate ASC", Q3);
                }
                else if (tCoNo.TrimTextLenth() > 0)
                {
                    GetData("bshopdisd", "CoNo", tCoNo.Text.Trim(), "CoNo ASC", Q7);
                }
                else if (tFaNo.TrimTextLenth() > 0)
                {
                    GetData("bshopdisd", "FaNo", tFaNo.Text.Trim(), "FaNo ASC", Q4);
                }
                else if (tItNo.TrimTextLenth() > 0)
                {
                    GetData("bshopdisd", "ItNo", tItNo.Text.Trim(), "ItNo ASC", Q5);
                }
                else if (tMemo.TrimTextLenth() > 0)
                {
                    GetData("bshopdisd", "Memo", tMemo.Text.Trim(), "Memo ASC", Q6);
                }
        ...
        void Fill(int index)
        {
            ...
            using (SqlCommand cmd = cn.CreateCommand())
            {
                ...
                cn.Open();
                cmd.CommandText = " Select * from bshopdis where dino = @dino ";
        ...
        private void btnInputDay_Click(object sender, EventArgs e)
        {
            ...
            dataGridViewT1.DataSource = null;
            Common.Cload(dtD, SQL, "bshopdis.InputDay", Date.GetDateTime(2));
            dataGridViewT1.DataSource = dtD.DefaultView;
