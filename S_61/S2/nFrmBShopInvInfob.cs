...
namespace S_61.S2
{
    public partial class nFrmBShopInvInfob : Formbase
    {
        public DataSet ds { get; set; }
        public String X5Name { get; set; }

        public nFrmBShopInvInfob()
        {
            InitializeComponent();
        ...
        void OutReport(RptMode mode)
        {
            ...
            if (radioT1.Checked)
            {
                path = Common.reportaddress + "Report\\公司別進項發票_簡要表.rpt";
            }
            else
            {
                path = Common.reportaddress + "Report\\公司別進項發票_明細表.rpt";
            }
