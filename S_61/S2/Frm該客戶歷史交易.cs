...
namespace S_61.S2
{
    public partial class Frm該客戶歷史交易 : Formbase
    {
        JBS.JS.xEvents xe;
        public string cuno = "";
        public string itno = "";
        ...
        public Frm該客戶歷史交易()
        {
            ...
            textBoxT3.Visible = textBoxT4.Visible = Common.User_SalePrice;
        }

        private void Frm該客戶歷史交易_Load(object sender, EventArgs e)
        {
            //該客戶交易，只定位在客戶
            textBoxT1.Text = cuno;
        ...
        void LoadDB()
        {
            ...
            using (SqlCommand cmd = cn.CreateCommand())
            {
                ...
                cmd.Parameters.AddWithValue("cuno", textBoxT1.Text.Trim());
                cmd.CommandText = "select 單據='銷退',* from rsaled where cuno=(@cuno)";
                ...
                cmd.CommandText = "select 單據='銷貨',* from saled where cuno=(@cuno)";
                using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                {
                    da.Fill(dtD);
                }
                ...
                dtD.DefaultView.Sort = "sadate DESC";
