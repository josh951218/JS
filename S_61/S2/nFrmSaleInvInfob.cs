...
namespace S_61.S2
{
    public partial class nFrmSaleInvInfob : Formbase
    {
        public DataSet ds { get; set; }
        public String X5Name { get; set; }

        public nFrmSaleInvInfob()
        {
            InitializeComponent();
        ...
        void SetRdUdf()
        {
            ...
            pVar.SetRadioUdf(pnlist, "SaleInv");
        }
        ...
        void OutReport(RptMode mode)
        {
            ...
            if (radioT1.Checked)
            {
                path = Common.reportaddress + "Report\\公司別銷項發票_簡要表.rpt";
            }
            else
            {
                path = Common.reportaddress + "Report\\公司別銷項發票_明細表.rpt";
            }
        ...
        private void btnDefault_Click(object sender, EventArgs e)
        {
            List<Control> pnlist = new List<Control>();
            pnlist.Add(groupBoxT2); 
            pVar.SaveRadioUdf(pnlist, "SaleInv");
        }
    }
}
