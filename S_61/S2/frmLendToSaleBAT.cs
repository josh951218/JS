...
namespace S_61.S2
{
    public partial class frmLendToSaleBAT : Formbase
    {
        JBS.JS.xEvents xe;
        public string cuno = "";
        ...
        private void LoadMaster()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter(cmd))
            {
                ...
                //where lendd.qtynotout > 0  And (leoverflag='0' or leoverflag is null) and lendd.cuno=(@cuno) 
        ...
        private void buttonSmallT1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var itemarray = dtSaleD.Rows[index].ItemArray;
                var row = dtSaleD.NewRow();
