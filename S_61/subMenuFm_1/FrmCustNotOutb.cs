...
{
    public partial class FrmCustNotOutb : Formbase
    {
        ...
        private void FrmCustNotOutb_Load(object sender, EventArgs e)
        {
            //依客戶編號交貨日期排序
            Dt = Dt.AsEnumerable().OrderBy(r=>r["esdate"].ToString().Trim()).CopyToDataTable();
            Dt = Dt.AsEnumerable().OrderBy(r => r["cuno"].ToString().Trim()).CopyToDataTable();
        ...
        private void btnBrowT1_Click(object sender, EventArgs e)
        {
            ...
            Dt.DefaultView.Sort = "cuno,esdate";
            SetButtonColor();
        ...
        private void btnBrowT2_Click(object sender, EventArgs e)
        {
            txtmiddle = "2";
            NO = dataGridViewT1.SelectedRows[0].Cells["序號"].Value.ToString();
            Dt.DefaultView.Sort = "cuno,itno,esdate";
            SetButtonColor();
        ...
        void paramsInit()
        {
            ...
            if(Common.Sys_DBqty == 1)
                path = Common.reportaddress + "Report\\客戶別未交貨訂單" + txtmiddle + HaveO + HaveBom + ".rpt";
            else if (Common.Sys_DBqty == 2)
                path = Common.reportaddress + "Report\\客戶別未交貨訂單" + txtmiddle + HaveO + HaveBom + "P.rpt";
            ...
            rp = new RPT(DtD, path);
            rp.office = txtmiddle + "客戶別未交貨訂單";
            rp.lobj.Add(new string[] { "txtend", txtend });
            rp.lobj.Add(new string[] { "txtmiddle", "客戶別-未交貨訂單" });
        ...
        private void dataGridViewT1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            textBoxT1.Text = dataGridViewT1.SelectedRows[0].Cells["客戶編號"].Value.ToString();
