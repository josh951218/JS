...
{
    public partial class FrmFactNotInb : Formbase
    {
        ...
        private void FrmFactNotInb_Load(object sender, EventArgs e)
        {
        ...
        void WriteToTitle()
        {
            textBoxT1.Text = Dt.Rows[0]["fano"].ToString();
        ...
        private void btnBrowT1_Click(object sender, EventArgs e)
        {
            ...
            Dt.DefaultView.Sort = "fano,esdate";
            SetButtonColor();
        ...
        private void btnBrowT2_Click(object sender, EventArgs e)
        {
            txtmiddle = "2";
            NO = dataGridViewT1.SelectedRows[0].Cells["序號"].Value.ToString();
            Dt.DefaultView.Sort = "fano,itno,esdate";
            SetButtonColor();
        ...
        void paramsInit()
        {
            ...
            if(Common.Sys_DBqty == 1)
                path = Common.reportaddress + "Report\\廠商別未到貨明細" + txtmiddle + HaveO + ".rpt";
            else if (Common.Sys_DBqty == 2)
                path = Common.reportaddress + "Report\\廠商別未到貨明細" + txtmiddle + HaveO + "P.rpt";
            ...
            rp = new RPT(Dt, path);
            rp.office = txtmiddle + "廠商別未到貨明細";
            rp.lobj.Add(new string[] { "txtend", txtend });
            rp.lobj.Add(new string[] { "txtmiddle", "廠商別-未到貨明細" });
        ...
        private void dataGridViewT1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            textBoxT1.Text = dataGridViewT1.SelectedRows[0].Cells["廠商編號"].Value.ToString();
