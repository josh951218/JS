...
namespace S_61.S0
{
    public partial class FrmNMachineSale_Rpt : JE.MyControl.Formbase
    {
        JBS.JS.xEvents xe;

        public FrmNMachineSale_Rpt()
        {
            InitializeComponent();
        ...
        private void FrmNMachineSale_Rpt_Load(object sender, EventArgs e)
        {
        ...
        void OutReport(RptMode mode)
        {
            ...
            var path = Common.reportaddress + @"ReportF\機台業績統計表.frx";
