...
{
    public partial class FrmSaleInvInfoc : Formbase
    {
        ...
        private void FrmSaleInvInfoc_Load(object sender, EventArgs e)
        { 
            //ReportFileName = "銷項發票瀏覽彙總表";

            rd2.SetUserDefineRpt("銷項發票瀏覽彙總表_自定一.rpt");
            rd3.SetUserDefineRpt("銷項發票瀏覽彙總表_自定二.rpt");
        ...
        void paramsInit()
        {
            ReportPath = Common.reportaddress + "Report\\" + "銷項發票瀏覽彙總表";
            if (rd1.Checked)
            {
