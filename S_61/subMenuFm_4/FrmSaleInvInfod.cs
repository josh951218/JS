...
{
    public partial class FrmSaleInvInfod : Formbase
    {
        ...
        private void FrmSaleInvInfod_Load(object sender, EventArgs e)
        { 
            //ReportFileName = "進項發票瀏覽明細表";

            rd2.SetUserDefineRpt("進項發票瀏覽明細表_自定一.rpt");
            rd3.SetUserDefineRpt("進項發票瀏覽明細表_自定二.rpt");
        ...
        void paramsInit()
        {
            ReportPath = Common.reportaddress + "Report\\" + "進項發票瀏覽明細表";
            if (rd1.Checked)
            {
