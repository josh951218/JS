...
{
    public partial class FrmItemSale_Rpt : Formbase
    {
        class 成本計算
        {
            bool sale = false;
            ...
            public void 月平均成本(out DataTable dtResult)
            {
                ...
                using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                {
                    ...
                    if (sale)
                    {
                        ...
                        ,sano, saID, sadate, sadate1, sadateac1, sadateac, saled.cuno, orno,stkroom.stname, itno, itname, ittrait, itunit, itpkgqty
                        ,qty=ISNULL(qty,0), (priceb)price, prs, (taxpriceb)taxprice, mny=ISNULL(mnyb,0), memo, bomid, bomrec, recordno, Pqty, Punit 
                        from saled 
                        left join cust on saled.cuno = cust.cuno
                        left join stkroom on saled.stno=stkroom.stno
                        where 0=0 " + sQuery;
                        da.Fill(saleSandR);
                    }
                    ...
                    if (rsale)
                    {
                        ...
                        ,sano, saID, sadate, sadate1, sadateac1, sadateac, rsaled.cuno, orno,stkroom.stname, itno, itname, ittrait, itunit, itpkgqty
                        ,qty=(-1)*ISNULL(qty,0), (priceb)price, prs, (taxpriceb)taxprice, mny=(-1)*ISNULL(mnyb,0), memo, bomid, bomrec, recordno, Pqty, Punit 
                        from rsaled 
                        left join cust on rsaled.cuno = cust.cuno
                        left join stkroom on rsaled.stno=stkroom.stno
                        where 0=0 " + rQuery;
                        da.Fill(saleSandR);
                    }
                    ...
                    if (sale)
                    {
                        cmd.CommandText = "Select 單據='銷貨',saled.bomid,substring(sadate,1,5)月份,stno,itno,mny=ISNULL(mnyb,0),母數量=qty*itpkgqty from saled where ittrait <> 1 " + sQuery;
                        da.Fill(saled23);
                    }

                    if (rsale)
                    {
                        cmd.CommandText = "Select 單據='銷退',rsaled.bomid,substring(sadate,1,5)月份,stno,itno,mny=(-1)*ISNULL(mnyb,0),母數量=(-1)*qty*itpkgqty from rsaled where ittrait <> 1 " + rQuery;
                        da.Fill(rsaled23);
                    }
                    ...
                    {
                        cmd.CommandText = @"
                        Select 銷貨成本=0.0,單據='銷貨',saled.bomid,substring(sadate,1,5)月份,saled.stno,saled.itno sitno,bom.itno,mny=ISNULL(mnyb,0),母數量=saled.qty*saled.itpkgqty,子數量=(bom.itqty*bom.itpkgqty/bom.itpareprs) from salebom bom
                    ...
                    {
                        cmd.CommandText = @"
                        Select 銷貨成本=0.0,單據='銷退',rsaled.bomid,substring(sadate,1,5)月份,rsaled.stno,rsaled.itno sitno,bom.itno,mny=(-1)*ISNULL(mnyb,0),母數量=(-1)*rsaled.qty*rsaled.itpkgqty,子數量=(bom.itqty*bom.itpkgqty/bom.itpareprs) from rsalebom bom
            ...
            public void 最後一次進貨成本(out DataTable dtResult)
            {
                ...
                using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                {
                    ...
                    {
                        cmd.CommandText = @"
                        Select 銷貨成本=0.0,單據='銷貨',saled.bomid,saled.sadate,saled.itno sitno,bom.itno,mny=ISNULL(mnyb,0),母數量=saled.qty*saled.itpkgqty,子數量=(bom.itqty/bom.itpareprs),bom.itpkgqty,bom.itunit,item.itbuypri
                        From saled 
                        Left join item on saled.itno = item.itno
                    ...
                    {
                        cmd.CommandText = @"
                        Select 銷貨成本=0.0,單據='銷退',rsaled.bomid,rsaled.sadate,rsaled.itno sitno,bom.itno,mny=(-1)*ISNULL(mnyb,0),母數量=(-1)*rsaled.qty*rsaled.itpkgqty,子數量=(bom.itqty/bom.itpareprs),bom.itpkgqty,bom.itunit,item.itbuypri
                        From rsaled 
                        Left join item on rsaled.itno = item.itno
            ...
            public void 標準成本(out DataTable dtResult)
            {
                ...
                using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                {
                    ...
                    if (sale)
                    {
                        cmd.CommandText = "Select 單據='銷貨',saled.bomid,itno,mny=ISNULL(mnyb,0),母數量=qty,itpkgqty from saled where ittrait <> 1 " + sQuery;
                        da.Fill(saled23);
                    }

                    if (rsale)
                    {
                        cmd.CommandText = "Select 單據='銷退',rsaled.bomid,itno,mny=(-1)*ISNULL(mnyb,0),母數量=(-1)*qty,itpkgqty from rsaled where ittrait <> 1 " + rQuery;
                        da.Fill(rsaled23);
                    }
                    ...
                    {
                        cmd.CommandText = @"
                        Select 銷貨成本=0.0,單據='銷貨',saled.bomid,saled.itno sitno,bom.itno,mny=ISNULL(mnyb,0),母數量=saled.qty*saled.itpkgqty,子數量=(bom.itqty/bom.itpareprs),bom.itpkgqty from salebom bom
                        right join saled on bom.bomid = saled.bomid 
                        where saled.ittrait = 1 and (bom.itpareprs <> 0 or bom.itpareprs is null) " + sQuery;
                        da.Fill(saled1);
                    }
                    ...
                    {
                        cmd.CommandText = @"
                        Select 銷貨成本=0.0,單據='銷退',rsaled.bomid,rsaled.itno sitno,bom.itno,mny=(-1)*ISNULL(mnyb,0),母數量=(-1)*rsaled.qty*rsaled.itpkgqty,子數量=(bom.itqty/bom.itpareprs),bom.itpkgqty from rsalebom bom
                        right join rsaled on bom.bomid = rsaled.bomid 
                        where rsaled.ittrait = 1 and (bom.itpareprs <> 0 or bom.itpareprs is null) " + rQuery;
                        da.Fill(rsaled1);
                    }
        ...
        private void FrmItemSale_Rpt_Load(object sender, EventArgs e)
        {
        ...
        private void FrmItemSale_Rpt_Shown(object sender, EventArgs e)
        {
            SaDate.Focus();
        }
        ...
        private void _SaDate_Validating(object sender, CancelEventArgs e)
        {
            if (btnExit.Focused)
                return;
        ...
        private void _INo_DoubleClick(object sender, EventArgs e)
        {
            xe.Open<JBS.JS.Item>(sender);
        }

        private void _INo_Validating(object sender, CancelEventArgs e)
        {
            if (btnExit.Focused)
                return;
        ...
        private void btnBrow_Click(object sender, EventArgs e)
        {
            ...
            {
                new 成本計算(ckSale.Checked, ckRsale.Checked, SaDate.Text, SaDate1.Text, ItNo.Text, ItNo1.Text, false).月平均成本(out dtResult);
            }
            else if (rdAvgByOneStk.Checked)
            {
                new 成本計算(ckSale.Checked, ckRsale.Checked, SaDate.Text, SaDate1.Text, ItNo.Text, ItNo1.Text, true).月平均成本(out dtResult);
            }
            ...
            if (rdSimple.Checked)
            {
                #region 簡要表
                #region rdSimple
                this.OpemInfoFrom<FrmItemSale_Rptb>(() =>
                            {
                                FrmItemSale_Rptb frm = new FrmItemSale_Rptb();
                                frm.TResult = dtResult.Copy(); ;
            ...
            else
            {
                ...
                //    //.Select(g => new
                //    //{
                //    //    obj = g.ElementAt(0).ItemArray,
                //    //    tQty = g.Sum(rw => rw["qty"].ToDecimal()),
                //    //    tMny = g.Sum(rw => rw["mny"].ToDecimal()),
                //    //    銷貨成本 = g.Sum(rw => rw["銷貨成本"].ToDecimal())
                //    //})
                //    .ForAll(g =>
                //    {
                ...
                dtResult.AsEnumerable()
                    ...
                    (
                        r => new
                        {
                            itunit = r.Field<string>("itunit"),
                            itno = r.Field<string>("itno")
                        }
                    )
                    .ForAll(g =>
                    {
                ...
                #endregion
                this.OpemInfoFrom<FrmItemSale_Rptc>(() =>
                            {
                                FrmItemSale_Rptc frm = new FrmItemSale_Rptc();
                                var rk = 0;
