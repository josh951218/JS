...
{
    public partial class FrmAge_Payabldb : Formbase
    {
        ...
        public FrmAge_Payabldb()
        {
            ...
            Num.ForEach(r =>
            {
                ...
                r.LastNum = Common.MFT;
            });
            this.RuleLv1.DefaultCellStyle.Format = "N" + Common.MFT;
            this.RuleLv2.DefaultCellStyle.Format = "N" + Common.MFT;
            this.RuleLv3.DefaultCellStyle.Format = "N" + Common.MFT;
            this.RuleLv4.DefaultCellStyle.Format = "N" + Common.MFT;
            this.RuleLv5.DefaultCellStyle.Format = "N" + Common.MFT;
        }

        private void FrmAge_Payabldb_Load(object sender, EventArgs e)
        {
            ...
            Lv1Count.Text = lv1.ToString("N" + Common.MFT);
            Lv2Count.Text = lv2.ToString("N" + Common.MFT);
            Lv3Count.Text = lv3.ToString("N" + Common.MFT);
            Lv4Count.Text = lv4.ToString("N" + Common.MFT);
            Lv5Count.Text = lv5.ToString("N" + Common.MFT);
            TotMny.Text = (lv1 + lv2 + lv3 + lv4 + lv5).ToString("N" + Common.MFT);
        ...
        {
            path = Common.reportaddress + "Report\\應付帳齡分析_總額表.rpt";
