...
namespace S_61.menu
{
    public partial class MenuFormJM : Form
    {
        ...
        private void MenuFormJM_Load(object sender, EventArgs e)
        {
            this.Location = new Point(1, 1);
        ...
        private void MenuFormJM_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
        }
        ...
        private void btnFrmNetOrder_Click(object sender, EventArgs e)
        {
        ...
        {
            this.OpenForm<S_61.subMenuFm_6.FrmEndThisYear>("");
        }
        ...
        {
            this.OpenForm<S_61.S4.FrmPOSReport>("");
        }
